...
const Search = () => {
    ...
    return (
        <div className={styles.container}>
            ...
            <input className={styles.input} type="text" placeholder={'Поиск пиццы'} value={searchValue}
                   onChange={(event) => setSearchValue(event.currentTarget.value)}/>
            {searchValue && <svg className={styles.close} onClick={() => setSearchValue('')} fill="#000000"
